...
class StoreTeacherRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nuptk' => ['nullable', 'string', 'max:30', Rule::unique('teachers', 'nuptk')],
    ...
    public function messages(): array
    {
        return [
            ...
            'nip.unique' => "NIP ':input' sudah terdaftar pada sistem.",
            'nuptk.unique' => "NUPTK ':input' sudah terdaftar pada sistem.",
